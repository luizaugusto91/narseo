    ...
    begin
      ...
      if Settings.Modo = 'SALDO' then
        begin
          qSQL.Open;
          qSaldo.Close;
          qSaldo.ParamByName('baixa').AsInteger := qSQL.FieldByName('codigo').AsInteger;
          qSaldo.ParamByName('pessoa').AsInteger := qContas.FieldByName('cd_pessoa').AsInteger;
          qSaldo.Open;
          qSQL.Close;
        end;
    end;
...
begin
  ...
  if ds.State in [dsInsert] then
    begin
      ...
      if Settings.Modo = 'SALDO' then
        begin
          ds.DataSet.FieldByName('tipo_pagamento').AsInteger := 0;
          qCedente.Close;
