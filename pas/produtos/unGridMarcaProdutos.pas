...
type
  TfrmGridMarcaProdutos = class(TfrmGrid)
...
var
  frmGridMarcaProdutos: TfrmGridMarcaProdutos;

implementation

{$R *.dfm}

uses unCadMarcaProdutos;

procedure TfrmGridMarcaProdutos.MnEditarClick(Sender: TObject);
begin
  inherited;
  ActEditar(TfrmCadMarcaProdutos, frmCadMarcaProdutos);
end;

procedure TfrmGridMarcaProdutos.MnExcluirClick(Sender: TObject);
begin
  inherited;
  TabelaREF := 'produto_marcas';
  ActRemover(TfrmCadMarcaProdutos, frmCadMarcaProdutos);
end;

procedure TfrmGridMarcaProdutos.MnNovoClick(Sender: TObject);
begin
  inherited;
  ActInserir(TfrmCadMarcaProdutos, frmCadMarcaProdutos);
end;

procedure TfrmGridMarcaProdutos.MnVisualizarClick(Sender: TObject);
begin
  inherited;
  ActVisualizar(TfrmCadMarcaProdutos, frmCadMarcaProdutos);
end;

procedure TfrmGridMarcaProdutos.ViewDblClick(Sender: TObject);
