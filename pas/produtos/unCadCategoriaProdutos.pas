...
uses
  ...
  cxSpinEdit, Vcl.AppEvnts, dxGDIPlusClasses, cxImage;

type
  TfrmCadCategoriaProdutos = class(TfrmCad)
    qConsultacodigo: TIntegerField;
    qConsultacategoria: TStringField;
    qConsultabloqueado: TBooleanField;
    qConsultaiva: TFloatField;
    qConsultamargem_desconto: TFloatField;
    edtiva: TcxDBCalcEdit;
    edtmargem_desconto: TcxDBCalcEdit;
    cbbbloqueado: TcxDBCheckBox;
...
var
  frmCadCategoriaProdutos: TfrmCadCategoriaProdutos;
