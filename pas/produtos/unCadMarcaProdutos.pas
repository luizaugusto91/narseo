...
uses
  ...
  cxTextEdit, cxMaskEdit, cxSpinEdit, Vcl.AppEvnts, dxGDIPlusClasses, cxImage;

type
  TfrmCadMarcaProdutos = class(TfrmCad)
...
var
  frmCadMarcaProdutos: TfrmCadMarcaProdutos;
