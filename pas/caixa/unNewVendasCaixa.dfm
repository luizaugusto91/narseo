  ...
  inherited qConsulta: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO vendas'
        ...
        '  (codigo, empresa, pedido, cliente, representante, data_registr' +
        'o, data_venda, observacao)'
      'VALUES'
      
        '  (:codigo, :empresa, :pedido, :cliente, :representante, :data_r' +
        'egistro, :data_venda, :observacao)')
    SQLDelete.Strings = (
      'DELETE FROM vendas'
      'WHERE'
      '  codigo = :Old_codigo')
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'esentante = :representante, data_registro = :data_registro, data' +
        '_venda = :data_venda, observacao = :observacao'
      'WHERE'
      '  codigo = :Old_codigo')
    SQLLock.Strings = (
      'SELECT * FROM vendas'
    ...
    SQLRefresh.Strings = (
        ...
        'SELECT empresa, pedido, cliente, representante, data_registro, d' +
        'ata_venda, observacao FROM vendas'
      'WHERE'
      '  codigo = :codigo')
    SQLRecCount.Strings = (
      'SELECT count(*) FROM ('
