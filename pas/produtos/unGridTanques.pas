...
type
  TfrmGridTanques = class(TfrmGrid)
...
var
  frmGridTanques: TfrmGridTanques;
...
procedure TfrmGridTanques.MnEditarClick(Sender: TObject);
begin
  inherited;
  ActEditar(TfrmCadTanques, frmCadTanques);
end;

procedure TfrmGridTanques.MnNovoClick(Sender: TObject);
begin
  inherited;
  ActInserir(TfrmCadTanques, frmCadTanques);
end;

procedure TfrmGridTanques.MnVisualizarClick(Sender: TObject);
begin
  inherited;
  ActVisualizar(TfrmCadTanques, frmCadTanques);
end;

procedure TfrmGridTanques.ViewDblClick(Sender: TObject);
