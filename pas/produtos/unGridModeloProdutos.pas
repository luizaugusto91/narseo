...
procedure TfrmGridModeloProdutos.MnEditarClick(Sender: TObject);
begin
  inherited;
  ActEditar(TfrmCadModeloProdutos, frmCadModeloProdutos);
end;

procedure TfrmGridModeloProdutos.MnExcluirClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmGridModeloProdutos.MnNovoClick(Sender: TObject);
begin
  inherited;
  ActInserir(TfrmCadModeloProdutos, frmCadModeloProdutos);
end;

procedure TfrmGridModeloProdutos.MnVisualizarClick(Sender: TObject);
begin
  inherited;
