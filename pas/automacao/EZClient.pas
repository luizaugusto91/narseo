...
type
  ...
  TClientLogonEx = function(  ClientID : Integer  ; ClientType : Smallint  ; ServerName : WideString  ;  CallPortNo : Word  ; EventsPortNo : Word  ; CallTimeout : Integer ; Event : UINT  ; hWnd : UINT ; wMsg : UINT ) : Integer; stdcall;
  ...
  TGetGradeProperties = function( ID : Integer  ; pNumber : PInteger ; pName : PWideString  ; pShortGradeName : PWideString  ; pCode : PWideString  ) : Integer; stdcall;
  TSetGradeProperties = function( ID : Integer  ; Number : Integer ; Name : WideString  ; ShortGradeName : WideString ; Code : WideString   ) : Integer; stdcall;
  ...
  TGetCardClientProperties = function( ID : Integer ; pNumber : PInteger ; pName : PWideString ; pTag : PWideString ; pEnabled : PSmallint )  : Integer; stdcall ;
...
implementation
  ...
  //----------------------------------------------------------------------------
  function TEZClient.LoadDll: Bool;
  var
      handle : THandle;
  begin
    LoadDll := false ;
    ...
    @TankDrop := GetProcAddress(handle, 'TankDrop');
    if @TankDrop = nil  then  exit ;
    ...
    @DeletePort := GetProcAddress(handle, 'DeletePort');
    if @DeletePort = nil  then  exit ;
