...
procedure TfrmView.btnCancelarClick(Sender: TObject);
begin
  ds.DataSet.Cancel;
  Close;
end;

procedure TfrmView.btnFecharClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmView.btnSalvarClick(Sender: TObject);
begin
  try
...
procedure TfrmView.GetHint(Sender: TObject);
var
  HelpString: String;
begin
...
procedure TfrmView.grpContentEnter(Sender: TObject);
begin
  Focus;
end;

procedure TfrmView.grpContentExit(Sender: TObject);
begin
  Focus;
end;

procedure TfrmView.imgHelpMouseEnter(Sender: TObject);
begin
  GetHint(Sender);
end;

procedure TfrmView.imgHelpMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  GetHint(Sender);
end;

procedure TfrmView.OpenQuery;
var i:Integer;
begin
  for I := 0 to ComponentCount -1 do
    begin
...
procedure TfrmView.SalvaFilhos;
var
  i: Integer;
begin
  for i := 0 to ComponentCount - 1 do
...
procedure TfrmView.ValidaCamposObrigatorios(Query: TUniQuery);
  var
    i: Integer;
    msg: string;
begin
