...
type
  TfrmEGridCTe = class(TfrmEGrid)
    ...
    procedure mniGerarcontasareceber1Click(Sender: TObject);
  private
...
procedure TfrmEGridCTe.mniGerarcontasareceber1Click(Sender: TObject);
var
  sAmbiente: String;
begin
  inherited;
...
begin
  inherited;
  if (ds.DataSet.FieldByName('financeiro').AsBoolean = False) and (ds.DataSet.FieldByName('status').asString = 'E') then
    mniGerarcontasareceber1.Enabled := True
  else
    mniGerarcontasareceber1.Enabled := False;
end;
