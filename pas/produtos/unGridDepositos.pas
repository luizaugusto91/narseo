...
type
  TfrmGridDepositos = class(TfrmGrid)
...
var
  frmGridDepositos: TfrmGridDepositos;
...
procedure TfrmGridDepositos.MnEditarClick(Sender: TObject);
begin
  inherited;
  ActEditar(TfrmCadDepositos, frmCadDepositos);
end;

procedure TfrmGridDepositos.MnNovoClick(Sender: TObject);
begin
  inherited;
  ActInserir(TfrmCadDepositos, frmCadDepositos);
end;

procedure TfrmGridDepositos.MnVisualizarClick(Sender: TObject);
begin
  inherited;
  ActVisualizar(TfrmCadDepositos, frmCadDepositos);
end;

procedure TfrmGridDepositos.ViewDblClick(Sender: TObject);
