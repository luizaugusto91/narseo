  ...
  object qterminais: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO pessoa_clientes'
        ...
        '  (data_inicial, data_final, client_hash, terminal_hash, server_' +
        'hash, inativo, pessoa)'
      'VALUES'
      
        '  (:data_inicial, :data_final, :client_hash, :terminal_hash, :se' +
        'rver_hash, :inativo, :pessoa)')
    SQLUpdate.Strings = (
    ...
    SQL.Strings = (
        ...
        'ash, '
      '       server_hash, inativo, pessoa, data_renovacao'
    ...
    object Fieldqterminais_data_inicial: TDateField
      FieldName = 'data_inicial'
      Required = True
    end
    object Fieldqterminais_data_final: TDateField
      FieldName = 'data_final'
    end
    object Fieldqterminais_client_hash: TStringField
      FieldName = 'client_hash'
      Size = 250
    end
    object Fieldqterminais_terminal_hash: TStringField
      FieldName = 'terminal_hash'
      Size = 250
    end
    object Fieldqterminais_server_hash: TStringField
