inherited frmCadConfigEmpresa: TfrmCadConfigEmpresa
  ...
  object PageControl: TcxPageControl [1]
    ...
    object TabGeral: TcxTabSheet
      ...
      object PageControlGeral: TcxPageControl
        ...
        object TabContato: TcxTabSheet
          ...
          object grpEndereco: TGroupBox
            ...
            object cbbCidade: TcxDBLookupComboBox
              ...
              Properties.ListSource = dmConfigEmpresa.dsCidade
              TabOrder = 10
            ...
            object cbbPais: TcxDBLookupComboBox
              ...
              Properties.ListSource = dmConfigEmpresa.dsPais
              TabOrder = 8
              OnEnter = grpContentEnter
              Width = 354
            end
        ...
        object TabFiscal2: TcxTabSheet
          Caption = 'Fiscal II '
          ImageIndex = 2
          object grpFiscal2: TGroupBox
            AlignWithMargins = True
            Left = 3
            Top = 3
            Width = 793
            ...
            object GroupBox1: TGroupBox
              ...
              object cbbCNAE: TcxDBLookupComboBox
                Left = 138
                Top = 24
          ...
          object PageControlCert: TcxPageControl
            ...
            object TabDocumentos: TcxTabSheet
              ...
              object grp7: TGroupBox
                ...
                ExplicitLeft = 6
                ExplicitTop = 6
                object cbbcfe: TcxDBCheckBox
                  Left = 21
                  Top = 24
                  Caption = 'Utilizar parametros configurados para emiss'#227'o de CF-e'
                  DataBinding.DataField = 'cfe'
                  DataBinding.DataSource = dsDocumentos
                  TabOrder = 0
                  Width = 676
                end
                object cbbcte: TcxDBCheckBox
                  Left = 21
                  Top = 53
                  Caption = 'Utilizar parametros configurados para emiss'#227'o de CT-e'
                  DataBinding.DataField = 'cte'
                  DataBinding.DataSource = dsDocumentos
                  TabOrder = 1
                  Width = 676
                end
                object cbbnfe: TcxDBCheckBox
                  Left = 21
                  Top = 82
                  Caption = 'Utilizar parametros configurados para emiss'#227'o de NF-e'
                  DataBinding.DataField = 'nfe'
                  DataBinding.DataSource = dsDocumentos
                  TabOrder = 2
                  Width = 676
                end
                object cbbnfce: TcxDBCheckBox
                  Left = 21
                  Top = 111
                  Caption = 'Utilizar parametros configurados para emiss'#227'o de NFC-e'
    ...
    object TabRegrasNegocio: TcxTabSheet
      Caption = 'Regras de Negocio'
      ImageIndex = 3
      object GroupBox2: TGroupBox
        ...
        object grprnCompras: TGroupBox
          ...
          Margins.Right = 6
          Align = alTop
          Caption = ' Configura'#231#245'es para compas '
          TabOrder = 0
          object lblcomprascentrocustos: TLabel
            Left = 14
            Top = 27
            Width = 94
            Height = 15
            Caption = 'Centro de Custos:'
            FocusControl = edtcompras_centro_custos
          end
          object lblcomprastipoConta: TLabel
            Left = 14
            Top = 56
            Width = 76
            Height = 15
            Caption = 'Tipo de conta:'
            FocusControl = edtcompras_tipo_conta
          end
          object lblcomprastipoPagamento: TLabel
            Left = 345
            Top = 56
            Width = 107
            Height = 15
            Caption = 'Tipo de pagamento:'
            FocusControl = edtcompras_tipo_pagamento
          end
          object edtcompras_centro_custos: TcxDBTextEdit
            Left = 114
            Top = 24
            DataBinding.DataField = 'compras_centro_custos'
            DataBinding.DataSource = dsRN
            TabOrder = 0
            Width = 100
          end
          object edtcompras_tipo_conta: TcxDBSpinEdit
            Left = 96
            Top = 53
            DataBinding.DataField = 'compras_tipo_conta'
            DataBinding.DataSource = dsRN
            Properties.SpinButtons.Visible = False
            TabOrder = 1
            Width = 60
          end
          object edtcompras_tipo_pagamento: TcxDBSpinEdit
            Left = 458
            Top = 53
            DataBinding.DataField = 'compras_tipo_pagamento'
            DataBinding.DataSource = dsRN
            Properties.SpinButtons.Visible = False
            TabOrder = 2
            Width = 60
          end
          object cbbComprasCentrocustos: TcxDBLookupComboBox
            Left = 220
            Top = 24
            DataBinding.DataField = 'compras_centro_custos'
            DataBinding.DataSource = dsRN
            ...
            Properties.ListFieldIndex = 1
            Properties.ListSource = dmConfigEmpresa.dsCCSaidas
            TabOrder = 3
            Width = 549
          end
          object cbbComprasTipoconta: TcxDBLookupComboBox
            Left = 162
            Top = 53
            DataBinding.DataField = 'compras_tipo_conta'
            DataBinding.DataSource = dsRN
            ...
            Properties.ListSource = dmConfigEmpresa.dsTipoConta
            TabOrder = 4
            Width = 177
          end
          object cbbComprasTipopagamento: TcxDBLookupComboBox
            Left = 524
            Top = 53
            DataBinding.DataField = 'compras_tipo_pagamento'
            DataBinding.DataSource = dsRN
            ...
            Properties.ListSource = dmConfigEmpresa.dsTipoPagamento
            TabOrder = 5
            Width = 245
          end
        end
        object grprnVendas: TGroupBox
          AlignWithMargins = True
          Left = 8
          Top = 111
          Width = 785
          ...
          Margins.Right = 6
          Align = alTop
          Caption = ' Configura'#231#245'es para vendas '
          TabOrder = 1
          object lblvendascentrocustos: TLabel
            Left = 14
            Top = 27
            Width = 94
            Height = 15
            Caption = 'Centro de Custos:'
            FocusControl = edtvendas_centro_custos
          end
          object lblvendastipoconta: TLabel
            Left = 14
            Top = 56
            Width = 76
            Height = 15
            Caption = 'Tipo de conta:'
            FocusControl = edtvendas_tipo_conta
          end
          object lblvendastipopagamento: TLabel
            Left = 345
            Top = 56
            Width = 107
            Height = 15
            Caption = 'Tipo de pagamento:'
            FocusControl = edtvendas_tipo_pagamento
          end
          object edtvendas_centro_custos: TcxDBTextEdit
            Left = 114
            Top = 24
            DataBinding.DataField = 'vendas_centro_custos'
            DataBinding.DataSource = dsRN
            TabOrder = 0
            Width = 100
          end
          object edtvendas_tipo_conta: TcxDBSpinEdit
            Left = 96
            Top = 53
            DataBinding.DataField = 'vendas_tipo_conta'
            DataBinding.DataSource = dsRN
            Properties.SpinButtons.Visible = False
            TabOrder = 1
            Width = 60
          end
          object edtvendas_tipo_pagamento: TcxDBSpinEdit
            Left = 458
            Top = 53
            DataBinding.DataField = 'vendas_tipo_pagamento'
            DataBinding.DataSource = dsRN
            Properties.SpinButtons.Visible = False
            TabOrder = 2
            Width = 60
          end
          object cbbVendasCentrocustos: TcxDBLookupComboBox
            Left = 220
            Top = 24
            DataBinding.DataField = 'vendas_centro_custos'
            DataBinding.DataSource = dsRN
            ...
            Properties.ListFieldIndex = 1
            Properties.ListSource = dmConfigEmpresa.dsCCEntradas
            TabOrder = 3
            Width = 549
          end
          object cbbVendasTipoconta: TcxDBLookupComboBox
            Left = 162
            Top = 53
            DataBinding.DataField = 'vendas_tipo_conta'
            DataBinding.DataSource = dsRN
          ...
          object cbbVendasTipopagamento: TcxDBLookupComboBox
            Left = 524
            Top = 53
            DataBinding.DataField = 'vendas_tipo_pagamento'
            DataBinding.DataSource = dsRN
  ...
  inherited grpContent: TGroupBox
    ...
    object cbbCDMatriz: TcxDBLookupComboBox
      ...
      Properties.ListSource = dsMatriz
      TabOrder = 4
      OnEnter = grpContentEnter
      Width = 353
    end
  ...
  object qFiscal: TUniQuery
    ...
    SQLInsert.Strings = (
      'INSERT INTO empresa_config'
        ...
        'ta_combatepobreza, destacar_icms, cnae)'
      'VALUES'
        ...
        'ofins, :aliquota_combatepobreza, :destacar_icms, :cnae)')
    SQLDelete.Strings = (
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'stacar_icms = :destacar_icms, cnae = :cnae'
      'WHERE'
      '  codigo = :Old_codigo')
    SQLLock.Strings = (
    ...
    SQLRefresh.Strings = (
        ...
        'iquota_combatepobreza, destacar_icms, cnae FROM empresa_config'
      'WHERE'
      '  codigo = :codigo')
    SQLRecCount.Strings = (
      'SELECT count(*) FROM ('
    ...
    object qFiscalcnae: TStringField
      FieldName = 'cnae'
      Size = 15
    end
  end
  ...
  object dsMatriz: TUniDataSource
    DataSet = qMatriz
    Left = 456
    Top = 208
  end
  ...
  object dsRN: TUniDataSource
    DataSet = qRN
    Left = 648
    Top = 264
  end
  object qDocumentos: TUniQuery
    Tag = 7100
    Connection = Connection.Conn
    SQL.Strings = (
      'SELECT codigo, '
    ...
    object FieldDocumentoscodigo: TIntegerField
      FieldName = 'codigo'
    end
    object FieldDocumentosempresa: TIntegerField
      FieldName = 'empresa'
      Required = True
    end
    object FieldDocumentoscfe: TBooleanField
      FieldName = 'cfe'
    end
    object FieldDocumentoscte: TBooleanField
      FieldName = 'cte'
    end
    object FieldDocumentosnfe: TBooleanField
      FieldName = 'nfe'
    end
    object FieldDocumentosnfce: TBooleanField
      FieldName = 'nfce'
    end
  end
  object dsDocumentos: TUniDataSource
    DataSet = qDocumentos
    Left = 672
    Top = 328
  end
