...
procedure TfrmBaixa.btnBaixarClick(Sender: TObject);
begin
  try
...
procedure TfrmBaixa.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = 112 then
    begin
...
procedure TfrmBaixa.GetHint(Sender: TObject);
var
  HelpString: String;
begin
...
procedure TfrmBaixa.grpContentEnter(Sender: TObject);
begin
  Focus;
end;

procedure TfrmBaixa.grpContentExit(Sender: TObject);
begin
  Focus;
end;

procedure TfrmBaixa.imgHelpMouseEnter(Sender: TObject);
begin
  GetHint(Sender);
end;

procedure TfrmBaixa.imgHelpMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  GetHint(Sender);
end;

procedure TfrmBaixa.OpenQuery;
var i:Integer;
begin
  for I := 0 to ComponentCount -1 do
    begin
...
procedure TfrmBaixa.SalvaFilhos;
var
  i: Integer;
begin
  for i := 0 to ComponentCount - 1 do
...
procedure TfrmBaixa.ValidaCamposObrigatorios(Query: TUniQuery);
  var
    i: Integer;
    msg: string;
begin
