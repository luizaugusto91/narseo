inherited frmCadPedidoCompraProdutos: TfrmCadPedidoCompraProdutos
  ...
  inherited qConsulta: TUniQuery
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  pedido = :pedido, produto = :produto, valor_unitario = :valor_' +
        'unitario, quantidade = :quantidade, desconto = :desconto, acresc' +
        'imo = :acrescimo, valor_total = :valor_total, entrada = :entrada' +
        ', cancelado = :cancelado'
      'WHERE'
      '  codigo = :Old_codigo')
    SQLLock.Strings = (
  ...
  object qProduto: TUniQuery
    ...
    SQL.Strings = (
      ...
      #9'nome'
      '   FROM produtos'
      '  WHERE inativo = false and tipo = '#39'P'#39)
    Left = 384
    Top = 65533
  end
